...
<head>
    ...
    <title>Save Transaction - PCV</title>
    <!-- Favicon-->
...
<body class="theme-darkblue">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="tab-content" style="margin-top: 0px; margin: -1px;">
                                ...
                                <div id="save_transaction" class="tab-pane fade in active">
                                    <?php
                                        if (isset($_POST['save_transaction'])) {
                                            header("location: save_transaction_pcv.php");
                                        }
                                        if (isset($_POST['print_forms'])) {
                                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                $_SESSION['cl_qn2'] = mysqli_real_escape_string($conn, $_POST['cl_qn']);
                                                $_SESSION['date_added'] = mysqli_real_escape_string($conn, $_POST['date_added']);
                                                header("location: print_forms_sw_pcv.php");
                                            }
                                        }
                                    ?>
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                        <input type="text" name="cl_qn" value="<?php echo $_SESSION['cl_qn'];?>" style="display: none;">
                                            <?php
                                                $date_added = $row_tbl_addl_entry['date_added'];
                                            ?>
                                        <input type="text" name="date_added" value="<?php echo $date_added;?>" style="display: none;">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <h4 style="margin: auto; padding: 10px 0; color: darkblue; text-decoration: underline;">Kindly click "Save" button first before clicking the "Print Forms".</h4>
                                                <div style="display: block; width: 100%;">
                                                    <ul class="pager">
                                                        <?php
                                                            $pcv_sql = mysqli_query($conn,"SELECT * FROM tbl_save_addl_entry WHERE transaction_code='".$row_tbl_addl_entry['gl_code']."' AND cl_qn='".$_SESSION['cl_qn']."' ");
                                                            if ($pcv_sql->num_rows > 0) {
                                                                ?>
                                                                    <li>
                                                                        <button type="submit" name="print_forms" class="btn btn-primary waves-effect" style="display: inline-block; float: left; margin: 0px 20px 10px;">
                                                                            Print Forms <span class="fa fa-print"></span>
                                                                        </button>
                                                                    </li>
                                                                <?php
                                                            } else {
                                                                ?>
                                                                    <li>
                                                                        <button type="submit" name="save_transaction" class="btn btn-success waves-effect" style="display: inline-block; float: left; margin: 0px 0px 10px;">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <h4 style="margin: auto; padding: 10px 0; text-align: left; color: red;">*NOTE: In case there are incorrect entries of data, kindly edit/modify them below.</h4>
                                                    </div>
                                                </div>
                                                <button class="btn btn-primary btn-xs" type="button" id="btn-show_more">
                                                    Show More <span class="fa fa-arrow-down"></span>
                                                </button>
                                                <button class="btn btn-primary btn-xs" type="button" id="btn-show_less">
                                                    Show Less <span class="fa fa-arrow-up"></span>
                                                </button>
                                                <div class="row" id="edit-addl-entry-pcv">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <?php
                                                            if (isset($_POST['edit_addl_entry'])) {
                                                                ...
                                                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                                    ...
                                                                    header("location: edit_addl_entry_pcv.php");
                                                                }
                                                            }
                                                        ?>
                                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                                                ...
                                                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                                                    ...
                                                                    <div class="clearfix">
                                                                        <div style="width: 100%;">
                                                                            <div class="form-group form-float" style="text-align: left;">
                                                                                <div class="form-line">
                                                                                    <label>15) PCV Code (<span style="color: red;">Note: This code is Auto-generated. You cannot edit the PCV Code anymore.</span>): <span style="color: red; font-size: 14px;">*</span></label><br>
                                                                                    <input type="hidden" class="form-control" name="swo_staffid" value="<?php echo $swo_staffid; ?>" readonly>
                                                                                    <input type="text" class="form-control" name="pcv_code" value="<?php echo $row_tbl_addl_entry['gl_code'];?>" readonly>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                ...
                                <!--<div id="pcv" class="tab-pane fade in">
                                    <button onclick="print_view_pcv()" class="btn btn-primary bg-darkblue waves-effect" name="print_view_gl" style="position: fixed; top: 145px;">
                                        Print <span class="fa fa-print"></span>
                                    </button>
                                    <page size="A4flex" layout="orientation" class="page2">
                                        ...
                                        <div style="width: 100%; height: 90px; position: relative;">
                                            ...
                                            <div style="width: 240px; height: 100%; border: solid black 1px; padding: 5px; position: absolute; left: 556px;">
                                                <p style="font-size: 16px; font-weight: bold;">No.: <u><?php echo $row_tbl_addl_entry['gl_code']; ?></u></p><br>
                                                <p style="font-size: 17px; font-weight: bold;">Date: <u><?php echo date_format(new DateTime($row['date_added']), "M. d, Y");?></u></p>
                                            </div>
                                        </div>
                                        ...
                                        <!--<div style="width: 100%; position: relative; top: 171px; font-size: 15px;"> -->
                                            ...
                                            <!--<div style="width: 399px;border: solid black 1px; position: absolute;">
                                                ...
                                                <br><br>
                                                <?php
                                                    $sql_approv_pcv = mysqli_query($conn,"SELECT * FROM tbl_signatories WHERE designation = 'Chief, Protective Services Division' ");
                                                    $row_approv_pcv = mysqli_fetch_assoc($sql_approv_pcv);
                                                ?>
                                                <p style="text-align: center; margin: 0px;"><b><u><?php echo strtoupper($row_approv_pcv['fname'])." "; if (empty($row_approv_pcv['mname'])) { echo ""; } else { echo strtoupper(substr($row_approv_pcv['mname'],0,1)).". "; } echo strtoupper($row_approv_pcv['lname']); if ($row_approv_pcv['nameext'] == "N/A") { echo ""; } else { echo ", ".$row_approv_pcv['nameext']; } if (empty($row_approv_pcv['suffix'])) {echo ''; } else { echo ', '.$row_approv_pcv['suffix']; } ?></u></b>
                                                </p>
                                                <p style="text-align: center;">Signature over Printed Name</p>
                                ...
                                <!--<div id="coe" class="tab-pane fade in">
                                    <button onclick="print_view_coe_pcv()" class="btn btn-primary bg-darkblue waves-effect" name="print_view_coe_gl" style="position: fixed; top: 145px;">
                                        Print <span class="fa fa-print"></span>
                                    </button>
                                    <page size="A4flex" layout="orientation" class="page2">
                                        <div class="header-logos">
    ...
    <script>   
        ...
        function print_view_pcv() {
          window.open("print_view_pcv.php");
        }
        function print_view_coe_pcv() {
          window.open("print_view_coe_pcv.php");
        }
        ...
        $(document).ready(function() {
            ...
            $("#edit-addl-entry-pcv").hide();
            $("#btn-show_less").hide();
            $("#btn-show_more").click(function() {
                $("#btn-show_more").hide();
                $("#btn-show_less").show();
                $("#edit-addl-entry-pcv").show(300);
            });
            $("#btn-show_less").click(function() {
                $("#btn-show_less").hide();
                $("#btn-show_more").show();
                $("#edit-addl-entry-pcv").hide(300);
            });
