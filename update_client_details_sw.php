<?php
    ...
    if ($row_clq['cl_reltobene'] == "Self") {
		...
		$sql = "UPDATE tbl_save_clientbene SET cl_pcn='$cl_pcn', cl_4Pschoice='$cl_4Pschoice', cl_4Psnum='$cl_4Psnum', cl_lname='$cl_lname', cl_fname='$cl_fname', cl_mname='$cl_mname', cl_nameext='$cl_nameext', cl_contact_num='$cl_contact_num', cl_bday='$cl_bday', cl_age='$cl_age', cl_cstatus='$cl_cstatus', cl_sex='$cl_sex', cl_occupation='$cl_occupation', cl_salary='$cl_salary', cl_reltobene='$cl_reltobene', cl_category='$cl_category', cl_subcategory='$cl_subcategory', cl_subcategory2='$cl_subcategory2', cl_ipAffiliation='$cl_ipAffiliation', cl_status='$cl_status' WHERE id_tbl_save_clientbene ='".$_SESSION['cl_qn2']."' ";
        if ($conn->query($sql) === TRUE) {
