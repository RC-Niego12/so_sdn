    ...
    <section class="content">
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                header("location: update_bene_details_sw.php");
            }
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="">
                                                        <ul class="pager" style="margin: auto auto 10px;">
                                                            ...
                                                            <li class=""><a style="color: white;"><button class="btn btn-primary btn-block waves-effect" type="submit">Save Changes <span class="fa fa-save"></button></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
