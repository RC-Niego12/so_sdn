...
<html>
    ...
    <body class="theme-darkblue">
        <page size="A4flex" layout="orientation" class="page2">
            ...
            <div class="">
                <div class="text-center" style="width: 70mm; display: inline-block;">
                    <p style="font-size: 13px;">CONFORME:</p><br>
                    <p class="print_view_coe_pcv">
                        <?php
                ...
                <div class="text-center" style="width: 69mm; display: inline-block;">
