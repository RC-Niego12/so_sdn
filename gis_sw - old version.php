                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="tab-content" style="margin-top: 0px; overflow-y: auto; margin: -1px;">
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                    ...
                                    <button class="btn btn-primary bg-darkblue waves-effect" name="proceed_to_data_entry" type="submit" style="position: fixed; top: 145px;">
                                        ...
                                        <page size="A4flex" layout="orientation" class="page2">
                                            ...
                                            <div class="container-assistance container-fluid">
                                                ...
                                                <div class="assistance-col" style="left: 485px;"> 
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div class="list-sub-category">
                                                                <p class="list-sub-category-p">Psychosocial First Aid (PFA)</p>
                                                ...
                                                <div class="assistance-col" style="left: 651px; width: 122px;">
                                                    <p>Referral:</p>
                                                    <ul>
                                                        <li></li>
                                                        <li></li>
                                            ...
                                            <div class="container-signatory container-fluid">
                                                ...
                                                <div class="interviewedby text-center">
                                                    ...
                                                    <p><u><b>_______________________________</b></u></p>
                                                    <p>Social Worker</p>
                                                    <i>(Signature over Printed Name)</i>
                                                </div>
