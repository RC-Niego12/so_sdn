<?php
    ...
    $result = mysqli_query($conn,"SELECT * FROM tbl_save_clientbene WHERE transaction_code='$gl_code' AND cl_qn='$cl_qn' AND cl_lname='$cl_lname' AND cl_fname='$cl_fname' AND cl_mname='$cl_mname' AND cl_nameext='$cl_nameext' AND bn_lname='$bn_lname' AND bn_fname='$bn_fname' AND bn_mname='$bn_mname' AND bn_nameext='$bn_nameext' ");
