    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="#" class="bars"></a>
                <a class="navbar-brand" href="#" title="Add Client 1.1) City/Municipal Address" style="color: white;"><?php echo $sysname.' ('.$sys_acronym.')'; ?>: Verifier Level</a>
            </div>
            ...
            if (isset($_POST['btn_submit_loc'])) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $_SESSION['cl_reg_code'] = mysqli_real_escape_string($conn, test_input($_POST['cl_reg_code']));
                            header("location: add_clientV2.php");
                }
            }
                                    ...
                                    <div class="tab-content" style="margin-top: 10px; overflow-y: auto; margin: -1px;">
                                        ...
                                        <div class="container-fluid" style="opacity: 0.9;">
                                            ...
                                            <div class="row">
                                                ...
                                                <h5 style="margin: -15px 0px 0px 15px; padding: 10px 0; color: darkblue; text-align: left;">1.1) City/Municipal Address</h5>
                                                <div style="width: 100%;">
                                                        ...
                                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                                            ...
                                                            <div class="clearfix col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_mc_name" name="cl_mc_name" required autofocus>
                                                                        <input type="hidden" class="form-control" id="cl_mc_code" name="cl_mc_code">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- Client Prov. Address -->
                                                            <div class="clearfix col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_pd_name" name="cl_pd_name" required autofocus>
                                                                        <input type="hidden" class="form-control" id="cl_pd_code" name="cl_pd_code">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- Client District -->
                                                            <div class="clearfix col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                <div class="form-group form-float" style="text-align: left;">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_dist" name="cl_dist">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="clearfix col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_reg_name" name="cl_reg_name" required autofocus>
                                                                        <input type="hidden" class="form-control" id="cl_reg_code" name="cl_reg_code">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="table-responsive" style="font-size: 1em; width: 100%;">
