        ...
        <div class="">
            <page size="A4flex" layout="orientation" class="page2">
                ...
                <div class="container-bene container-fluid">
                    ...
                    <div class="row-input">
                        <div class="otherinfo-row-input-div1 text-center">
                            <?php
                        ...
                        <div class="otherinfo-row-input-div2 text-center">
                            <?php echo date_format(new DateTime($row['bn_bday']), "M. d, Y");?>
                        </div>
                        <div class="otherinfo-row-input-div3 text-center">
                            <?php echo $row['bn_age'];?>
                        </div>
                        <div class="otherinfo-row-input-div4 text-center">
                            <?php echo $row['bn_sex'];?>
                        </div>
                        <div class="otherinfo-row-input-div5 text-center">
                            <?php echo $row['bn_occupation'];?>
                        </div>
                        <div class="otherinfo-row-input-div6 text-center">
                            <?php echo $row['bn_salary'];?>
                        </div>
                        <div class="otherinfo-row-input-div7 text-center">
