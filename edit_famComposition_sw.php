...
<head>
    ...
    <title>Edit Family Composition</title>
    <!-- Favicon-->
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    <li class="active">
                        <a href="edit_famComposition_sw.php">
    ...
    <section class="content">
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                header("location: update_famComposition_sw.php");
            }
                                        ...
                                        <div id="div-table" class="col-sm-12">
                                                            ...
                                                            while(($row_famcom = mysqli_fetch_array($sql_famcom)) && ($x <= 7)){
                                                                ?>
                                                                    <tr id="tbodyrow<?php echo $x; ?>" style="width: 100%;">
                                                                        <input type="hidden" id="id<?php echo $x; ?>" name="id<?php echo $x; ?>" value="<?php echo $row_famcom['num_series'];?>">
                                                                        <td>
                                            ...
                                            <div class="row">
                                                <ul class="pager" style="margin: 0px auto 10px;">
                                                    ...
                                                    <li class=""><a href="update_famComposition_sw.php" style="color: white;"><button class="btn btn-block btn-primary waves-effect" type="submit">Save Changes <span class="fa fa-save"></button></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
