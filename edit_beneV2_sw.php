...
<body class="theme-darkblue">
                ...
                <ul class="list">
                    <li class="active">
                        <a href="edit_clientV2_sw.php">
                            ...
                            <span>Edit Bene's Brgy. Address</span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <section class="content">
        <?php
            //client session
            $_SESSION['bn_brgy_name'] = $_SESSION['bn_brgy_code'] = $_SESSION['bn_purok'] = "";
            ...
            if (isset($_POST['btn_submit_loc'])) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    header("location: update_bene_address_sw.php");
                }
            }
                                ...
                                <div class="col-xs-12">
                                    <div class="tab-content" style="margin-top: 10px; overflow-y: auto; margin: -1px;">
                                        ...
                                        <div class="container-fluid" style="opacity: 0.9;">
                                            ...
                                            <div class="row">
                                                <h4 style="margin: auto; padding: 10px 0; color: darkblue; text-align: left;">II: BENE'S IDENTIFYING INFORMATION: Search Brgy. Address</h4>
                                                        ...
                                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="bn_brgy_name" name="bn_brgy_name" value="<?php echo $row_clq['bn_brgy'];?>" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row clearfix">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="bn_brgy_code" name="bn_brgy_code" value="<?php echo $row_clq['bn_brgy_code'];?>" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row clearfix">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" name="bn_purok" value="<?php echo $row_clq['bn_purok'];?>" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
