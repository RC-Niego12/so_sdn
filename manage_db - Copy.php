                                                        ...
                                                        if ($sql->num_rows > 0){
                                                            ...
                                                            while($row = mysqli_fetch_assoc($sql)) {
                                                                ...
                                                                $id1 = $row['id_tbl_save_clientbene'];
                                                                    //cl name
                                                                $cl_lname = $row['cl_lname']; $cl_fname = $row['cl_fname'];
                                                                if (($row['cl_mname']=='N/A') || ($row['cl_mname']=='n/a') || (empty($row['cl_mname']))) {
                                                                    $cl_mname = '';
                                                                } else {
                                                                ...
                                                                if (($row['bn_mname']=='N/A') || ($row['bn_mname']=='n/a') || (empty($row['bn_mname']))) {
                                                                    $bn_mname = '';
                                                                } else {
