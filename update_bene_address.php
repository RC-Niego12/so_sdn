<?php
    ...
    //insert staff
	$sql = "UPDATE tbl_clientqueue SET bn_purok='$bn_purok', bn_brgy='$bn_brgy', bn_brgy_code='$bn_brgy_code', bn_mun='$bn_mun', bn_mun_code='$bn_mun_code', bn_prov='$bn_prov', bn_prov_code='$bn_prov_code', bn_district='$bn_district', bn_region='$bn_region', bn_region_code='$bn_region_code' WHERE cl_qn='".$_SESSION['qn']."' ";
