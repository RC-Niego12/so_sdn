<?php 
    ...
    include 'config.php';
      ...
      $sql = mysqli_query($conn,"SELECT * FROM tbl_clientqueue WHERE cl_qn='".$_SESSION['qn']."' ");
    ...
    <div class="">
      <page size="A4flex" layout="orientation" class="page2">
        ...
        <div class="container-famcomposition container-fluid">
            ...
            <?php
                $sql2 = mysqli_query($conn,"SELECT * FROM tbl_famcomposition WHERE qn='".$_SESSION['qn']."' ");
                if ($sql2->num_rows > 0) {
...
<div class="footer-viewGIS">
  <ul class="pager" style="margin: 0px auto 10px;">
    <?php
          if ($row['cl_reltobene'] == "Self") {
                ...
                ?>
                      ...
                      <li>
                            <a href="edit_beneV1.php" style="color: white;">
                      ...
                      <li>
                            <a href="edit_beneV3.php" style="color: white;">
    ...
    ?>
    <li>
          <a href="edit_famComposition.php" style="color: white;">
                <button class="btn btn-block btn-primary waves-effect" type="submit">Edit Family Composition/Table Assignment <span class="fa fa-edit"></button>
          </a>
    </li>
    <li>
          <a href="add_morefam_members.php" style="color: white;">
                <button class="btn btn-block btn-primary waves-effect" type="submit">Add More Family Members <span class="fa fa-plus"></button>
          </a>
    </li>
    <li>
          <a href="home_verifier.php" style="color: white;">
                <button class="btn btn-block btn-success waves-effect" type="submit">OK <span class="fa fa-check"></button>
          </a>
    </li>
  </ul>
</div> 
