        ...
        <?php
            ...
            if (isset($_POST['btn_submit_loc'])) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    header("location: update_bene_address.php");
                }
            }
                                                        ...
                                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" name="bn_purok" placeholder="House No./St./Purok Address" value="<?php echo $row_clq['bn_purok'];?>" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
