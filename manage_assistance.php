...
<body class="theme-darkblue">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <ul class="nav nav-tabs" style="font-size: 15px;">
                                <li class="active">
                                    <a href="#manage_assistance" data-toggle="tab">
                                        <span class="fa fa-cogs" style="color: darkblue;"></span> Manage Assistance
                                    </a>
                                </li>
                                <li>
                                    <a href="#add_assistance" data-toggle="tab">
                                        <span class="fa fa-plus" style="color: darkblue;"></span> Add Assistance
                                    </a>
                                </li>
                            </ul>
                            <div class="tab-content" style="margin-top: 0px; overflow-y: auto; margin: -1px;">
                                <!-- manage_assistance -->
                                <div id="manage_assistance" class="tab-pane fade in active">
                                    <div class="table-responsive" style="overflow-x: hidden; font-size: 1em; width: 50%;">
                                            ...
                                            <?php
                                                ...
                                                if ($sql->num_rows > 0){
                                                    while($row = mysqli_fetch_assoc($sql)) {
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="text" value="<?php echo($row['assistance_id']);?>" style="width: 30px; text-align: center; border: none;" readonly>
                                                            <td><?php echo $row['assistance_type'];?></td>
                                                            <td><?php echo $row['assistance_purpose'];?></td>
                                                            <td>
                                                                <button class="btn btn-xs btn-primary waves-effect btn_edit_assistance" name="edit_assistance_modal" type="button" data-toggle="modal" title="Edit Assistance" data-target="#edit_assistance_modal" data-assistance_id="<?php echo $row['assistance_id'];?>" data-assistance_type="<?php echo $row['assistance_type'];?>" data-assistance_purpose="<?php echo $row['assistance_purpose'];?>">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="edit_assistance_modal" role="dialog">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                  <h4 class="modal-title"><span class="glyphicon glyphicon-pencil"></span> Edit Assistance Details</h4>
                                                </div>
                                                <div class="modal-body">
                                                    <?php
                                                        $_SESSION['modal_assistance_id'] = $_SESSION['modal_assistance_type'] = $_SESSION['modal_assistance_purpose'] = "";
                                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                            $_SESSION['modal_assistance_id'] = mysqli_real_escape_string($conn, test_input($_POST['modal_assistance_id']));
                                                            $_SESSION['modal_assistance_type'] = mysqli_real_escape_string($conn, test_input($_POST['modal_assistance_type']));
                                                            $_SESSION['modal_assistance_purpose'] = mysqli_real_escape_string($conn, test_input($_POST['modal_assistance_purpose']));
                                                            if (isset($_POST['edit_assistance'])) {
                                                                header("location: update_assistance.php");
                                                            }
                                                        }
                                                    ?>
                                                    <form method="POST" action="">
                                                        <input type="hidden" class="form-control" id="modal_assistance_id" name="modal_assistance_id">
                                                        <div class="col-sm-12">
                                                                ...
                                                                <div class="row clearfix">
                                                                    <div class="col-xs-11">
                                                                        <div class="form-group form-float">
                                                                            ...
                                                                            <div class="form-line">
                                                                                <input type="text" class="form-control" id="modal_assistance_type" name="modal_assistance_type" required autofocus>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xs-1">
                                                                ...
                                                                <div class="row clearfix">
                                                                    <div class="col-xs-11">
                                                                        <div class="form-group form-float">
                                                                            <label>Purpose:</label>
                                                                            <div class="form-line">
                                                                                <input type="text" class="form-control" id="modal_assistance_purpose" name="modal_assistance_purpose" required autofocus>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-xs-1">
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="btn-group">
                                                                <button type="submit" class="btn btn-block btn-primary waves-effect" name="edit_assistance"> Submit <span class="glyphicon glyphicon-send"></span></button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                ...
                                <!-- end manage_assistance -->
                                <!-- add_assistance -->
                                <div id="add_assistance" class="tab-pane fade in">
                                    <?php
                                        $_SESSION['assistance_type'] = $_SESSION['assistance_purpose'] = "";
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                            if (isset($_POST['add_assistance'])) {
                                                $_SESSION['assistance_type'] = mysqli_real_escape_string($conn, test_input($_POST['assistance_type']));
                                                $_SESSION['assistance_purpose'] = mysqli_real_escape_string($conn, test_input($_POST['assistance_purpose']));
                                                header("location: insert_newAssistance.php");
                                            }
                                        }
                                                ...
                                                <div class="panel-group">
                                                    <div class="panel panel-primary-dswd">
                                                        <div class="panel-heading panel-title"> 
                                                            <h4 class="text-center" style="margin: auto; padding: 10px 0; color: white;">Enter Assistance Details Below:</h4>
                                                        </div>
                                                        <div class="panel-body">
                                                            <!-- Type of Assistance -->
                                                            <div class="row clearfix">
                                                                <div class="col-xs-11">
                                                                    <div class="form-group form-float">
                                                                        <label>Type of Assistance:</label>
                                                                        <div class="form-line">
                                                                            <input type="text" class="form-control" id="assistance_type" name="assistance_type" required autofocus>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xs-1">
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="col-xs-11">
                                                                    <div class="form-group form-float">
                                                                        <label>Purpose:</label>
                                                                        <div class="form-line">
                                                                            <input type="text" class="form-control" id="assistance_purpose" name="assistance_purpose" required autofocus>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xs-1">
                                                            ...
                                                            <div class="panel-footer">
                                                                <ul class="pager">
                                                                    ...
                                                                    <li class="next"><a style="color: white;"><button class="btn btn-block btn-primary waves-effect" name="add_assistance" type="submit">Submit <span class="fa fa-paper-plane"></span></button></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $(".btn_edit_assistance").click(function(){
                var assistance_id = $(this).data('assistance_id');
                    $("#modal_assistance_id").val(assistance_id);
                    console.log(assistance_id);
                var assistance_type = $(this).data('assistance_type');
                    $("#modal_assistance_type").val(assistance_type);
                    console.log(assistance_type);
                var assistance_purpose = $(this).data('assistance_purpose');
                    $("#modal_assistance_purpose").val(assistance_purpose);
                    console.log(assistance_purpose);
            });
        });
    </script>
