<?php
    ...
    if (!empty($lname1)) {
        $sql1 = "UPDATE tbl_save_famcomposition SET lname='$lname1', fname='$fname1', mname='$mname1', nameext='$nameext1', reltobene='$reltobene1', bday='$bday1', age='$age1', occupation='$occupation1', salary='$salary1' WHERE id_tbl_save_famcomposition='".$_SESSION['cl_qn2']."' && num_series='$id1' ";
    ...
    if (!empty($lname2)) {
        $sql2 = "UPDATE tbl_save_famcomposition SET lname='$lname2', fname='$fname2', mname='$mname2', nameext='$nameext2', reltobene='$reltobene2', bday='$bday2', age='$age2', occupation='$occupation2', salary='$salary2' WHERE id_tbl_save_famcomposition='".$_SESSION['cl_qn2']."' && num_series='$id2' ";
    ...
    if (!empty($lname3)) {
        $sql3 = "UPDATE tbl_save_famcomposition SET lname='$lname3', fname='$fname3', mname='$mname3', nameext='$nameext3', reltobene='$reltobene3', bday='$bday3', age='$age3', occupation='$occupation3', salary='$salary3' WHERE id_tbl_save_famcomposition='".$_SESSION['cl_qn2']."' && num_series='$id3' ";
    ...
    if (!empty($lname4)) {
        $sql4 = "UPDATE tbl_save_famcomposition SET lname='$lname4', fname='$fname4', mname='$mname4', nameext='$nameext4', reltobene='$reltobene4', bday='$bday4', age='$age4', occupation='$occupation4', salary='$salary4' WHERE id_tbl_save_famcomposition='".$_SESSION['cl_qn2']."' && num_series='$id4' ";
    ...
    if (!empty($lname5)) {
        $sql5 = "UPDATE tbl_save_famcomposition SET lname='$lname5', fname='$fname5', mname='$mname5', nameext='$nameext5', reltobene='$reltobene5', bday='$bday5', age='$age5', occupation='$occupation5', salary='$salary5' WHERE id_tbl_save_famcomposition='".$_SESSION['cl_qn2']."' && num_series='$id5' ";
    ...
    if (!empty($lname6)) {
        $sql6 = "UPDATE tbl_save_famcomposition SET lname='$lname6', fname='$fname6', mname='$mname6', nameext='$nameext6', reltobene='$reltobene6', bday='$bday6', age='$age6', occupation='$occupation6, salary='$salary6' WHERE id_tbl_save_famcomposition='".$_SESSION['cl_qn2']."' && num_series='$id6' ";
    ...
    if (!empty($lname7)) {
        $sql7 = "UPDATE tbl_save_famcomposition SET lname='$lname7', fname='$fname7', mname='$mname7', nameext='$nameext7', reltobene='$reltobene7', bday='$bday7', age='$age7', occupation='$occupation7', salary='$salary7' WHERE id_tbl_save_famcomposition='".$_SESSION['cl_qn2']."' && num_series='$id7' ";
	...
	$conn->close();
    header("location: edit_famComposition_sw.php");
?>