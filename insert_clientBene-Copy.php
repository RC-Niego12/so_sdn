<?php
    ...
    //CATEGORY
    $cl_category_exp = explode(',', $_SESSION['cl_category']);
    $cl_category_arrval = array_values($cl_category_exp);
    $count = count($cl_category_arrval)-1;
    $cl_category = $bn_category = $_SESSION['cl_category'];
    echo 'cl_category: '.$_SESSION['cl_category'].'<br>';
    echo '# of Checked boxes cl_category: '.$count.'<br>';
    //SUB-CATEGORY
    $cl_subcategory_exp = explode(',', $_SESSION['cl_subcategory']);
    $cl_subcategory_arrval = array_values($cl_subcategory_exp);
    $cl_subcategory = $bn_subcategory = $_SESSION['cl_subcategory'];
    $count2 = count($cl_subcategory_arrval)-1;
    echo 'cl_subcategory: '.$_SESSION['cl_subcategory'].'<br>';
    echo '# of Checked boxes cl_subcategory: '.$count2;
