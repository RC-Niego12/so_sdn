...
<body class="theme-darkblue">
                ...
                <ul class="list">
                    <li class="active">
                        <a href="edit_clientV1_sw.php">
                            ...
                            <span>Edit Client's City/Mun. Address</span>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <?php
            ...
            if (isset($_POST['btn_submit_loc'])) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    $_SESSION['cl_mc_name'] = mysqli_real_escape_string($conn, test_input($_POST['cl_mc_name']));
                    $_SESSION['cl_mc_code'] = mysqli_real_escape_string($conn, test_input($_POST['cl_mc_code']));
                    $_SESSION['cl_pd_name'] = mysqli_real_escape_string($conn, test_input($_POST['cl_pd_name']));
                    $_SESSION['cl_pd_code'] = mysqli_real_escape_string($conn, test_input($_POST['cl_pd_code']));
                    $_SESSION['cl_dist'] = mysqli_real_escape_string($conn, test_input($_POST['cl_dist']));
                    $_SESSION['cl_reg_name'] = mysqli_real_escape_string($conn, test_input($_POST['cl_reg_name']));
                    $_SESSION['cl_reg_code'] = mysqli_real_escape_string($conn, test_input($_POST['cl_reg_code']));
                            header("location: edit_clientV2_sw.php");
                }
            }
                                ...
                                <div class="col-xs-12">
                                    <div class="tab-content" style="margin-top: 10px; overflow-y: auto; margin: -1px;">
                                        ...
                                        <div class="container-fluid" style="opacity: 0.9;">
                                            ...
                                            <div class="row">
                                                <h4 style="margin: auto; padding: 10px 0; color: darkblue; text-align: left;">I: BENE'S IDENTIFYING INFORMATION: Search Address</h4>
                                                <div style="width: 100%;">
                                                        ...
                                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                                            ...
                                                            <div class="clearfix col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_mc_name" name="cl_mc_name" value="<?php echo $row_clq['cl_mun'];?>" required autofocus>
                                                                        <input type="hidden" class="form-control" id="cl_mc_code" name="cl_mc_code" value="<?php echo $row_clq['cl_mun_code'];?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- Client Prov. Address -->
                                                            <div class="clearfix col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_pd_name" name="cl_pd_name" value="<?php echo $row_clq['cl_prov'];?>" required autofocus>
                                                                        <input type="hidden" class="form-control" id="cl_pd_code" name="cl_pd_code" value="<?php echo $row_clq['cl_prov_code'];?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- Client District -->
                                                            <div class="clearfix col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                <div class="form-group form-float" style="text-align: left;">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_dist" name="cl_dist" value="<?php echo $row_clq['cl_district'];?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="clearfix col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_reg_name" name="cl_reg_name" value="<?php echo $row_clq['cl_region'];?>" required autofocus>
                                                                        <input type="hidden" class="form-control" id="cl_reg_code" name="cl_reg_code" value="<?php echo $row_clq['cl_region_code'];?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <script>
        ...
        $('.js-basic-example tbody').on('click', 'tr', function() {
            ...
            $("#cl_mc_name").val(data[1]);
            console.log(data[1]);
            $("#cl_mc_code").val(data[2]);
            console.log(data[2]);
            $("#cl_pd_name").val(data[3]);
            console.log(data[3]);
            $("#cl_pd_code").val(data[4]);
            console.log(data[4]);
            $("#cl_dist").val(data[5]);
            console.log(data[5]);
            $("#cl_reg_name").val(data[6]);
            console.log(data[6]);
            $("#cl_reg_code").val(data[7]);
            console.log(data[7]);
        });
    </script>
</script>
