...
<body class="theme-darkblue">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    <li class="active">
                        <a href="edit_famComposition.php">
                            <span class="fa fa-edit"></span>
                            <span>Edit Family Composition</span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <section class="content">
        <?php
            ...
            $_SESSION['id1'] = $_SESSION['id2'] = $_SESSION['id3'] = $_SESSION['id4'] = $_SESSION['id5'] = $_SESSION['id6'] = $_SESSION['id7'] = "";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                $_SESSION['id1'] = mysqli_real_escape_string($conn, test_input($_POST['id1']));
                ...
                $_SESSION['id2'] = mysqli_real_escape_string($conn, test_input($_POST['id2']));
                ...
                $_SESSION['id3'] = mysqli_real_escape_string($conn, test_input($_POST['id3']));
                ...
                $_SESSION['id4'] = mysqli_real_escape_string($conn, test_input($_POST['id4']));
                ...
                $_SESSION['id5'] = mysqli_real_escape_string($conn, test_input($_POST['id5']));
                ...
                $_SESSION['id6'] = mysqli_real_escape_string($conn, test_input($_POST['id6']));
                ...
                header("location: update_famComposition.php");
            }
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                    ...
                                    <div class="row">
                                        <div id="div-table" class="col-sm-12">
                                            <p style="text-align: left; font-size: 14px; font-weight: bold; color: red;">NOTE: You can only edit entries here. You can't add more family members! Go back to GIS page and click ADD MORE FAMILY MEMBERS button instead.</p>
                                            <table style="width: 100%;">
                                                ...
                                                <tbody id="tbody">
                                                    <?php
                                                        $sql_famcom = mysqli_query($conn,"SELECT * FROM tbl_famcomposition WHERE qn='".$_SESSION['qn']."' ");
                                                        if ($sql_famcom->num_rows > 0) {
                                                            $x = 1;
                                                            while(($row_famcom = mysqli_fetch_array($sql_famcom)) && ($x <= 7)){
                                                                ?>
                                                                    <tr id="tbodyrow<?php echo $x; ?>" style="width: 100%;">
                                                                        <input type="hidden" id="id<?php echo $x; ?>" name="id<?php echo $x; ?>" value="<?php echo $row_famcom['id'];?>">
                                                                        <td>
                                                                            <input type="text" class="form-control" name="lname<?php echo $x; ?>" value="<?php echo $row_famcom['lname']; ?>" placeholder="1) Last Name" required autofocus>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="form-control" name="fname<?php echo $x; ?>" value="<?php echo $row_famcom['fname']; ?>" placeholder="First Name" required autofocus>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="form-control" name="mname<?php echo $x; ?>" value="<?php echo $row_famcom['mname']; ?>" placeholder="Middle Name">
                                                                        </td>
                                                                        <td>
                                                                            <select class="form-control addform-control" name="nameext<?php echo $x; ?>">
                                                                                <option><?php echo $row_famcom['nameext']; ?></option>
                                                                                <option>N/A</option>
                                                                                <option>JR.</option>
                                                                                <option>SR.</option>
                                                                                <option>I</option>
                                                                        ...
                                                                        <td>
                                                                            <select class="form-control addform-control" id="reltobene<?php echo $x; ?>" name="reltobene<?php echo $x; ?>">
                                                                                <!-- Direct Family -->
                                                                                <option><?php echo $row_famcom['reltobene']; ?></option>
                                                                        ...
                                                                        <td>
                                                                            <input type="date" class="form-control" id="bday<?php echo $x; ?>" name="bday<?php echo $x; ?>" value="<?php echo $row_famcom['bday']; ?>" required autofocus>
                                                                        </td>
                                                                        <td>
                                                                            <input type="number" maxlength="2" class="form-control" id="age<?php echo $x; ?>" name="age<?php echo $x; ?>" value="<?php echo $row_famcom['age']; ?>" placeholder="Click here to show Age" required autofocus>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text" class="form-control" name="occupation<?php echo $x; ?>" value="<?php echo $row_famcom['occupation']; ?>" placeholder="Occupation" required autofocus>
                                                                        </td>
                                                                        <td>
                                                                            <select class="form-control addform-control" name="salary<?php echo $x; ?>">
                                                                                <option><?php echo $row_famcom['salary']; ?></option>
                                                                                <option>N/A</option>
                                                ...
                                                <div class="row clearfix">
                                                    <?php
                                                        $sql_as_tbl = mysqli_query($conn,"SELECT * FROM tbl_assign_table WHERE cl_qn='".$_SESSION['qn']."' ");
                                                        $row_as_tbl = mysqli_fetch_assoc($sql_as_tbl);
                                                    ?>  
                                                        ...
                                                        <div class="form-group form-float" style="text-align: left;">
                                                            <div class="form-line">
                                                                ...
                                                                <select class="form-control" id="table_num" name="table_num">
                                                                    <option value="<?php echo $row_as_tbl['table_num']; ?>">Table <?php echo $row_as_tbl['table_num']; ?></option>
                                                                    <?php
                                                        ...
                                                        <div class="form-group form-float" style="text-align: left;">
                                                            <div class="form-line">
                                                                ...
                                                                <select class="form-control" id="assistance_type" name="assistance_type">
                                                                    <option><?php echo $row_as_tbl['assistance_type']; ?></option>
                                                                    <?php
                                                    ...
                                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                                        <div class="form-group form-float" style="text-align: left;">
                                                            <div class="form-line">
                                                                ...
                                                                <input type="text" class="form-control" id="remarks" name="remarks" value="<?php echo $row_as_tbl['remarks']; ?>" required autofocus>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <ul class="pager" style="margin: 0px auto 10px;">
                                                    ...
                                                    <li class=""><a href="update_famComposition.php" style="color: white;"><button class="btn btn-block btn-primary waves-effect" type="submit">Save Changes <span class="fa fa-save"></button></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
