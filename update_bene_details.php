<?php
    ...
    //update client
	$sql = "UPDATE tbl_clientqueue SET bn_4Pschoice='$bn_4Pschoice', bn_4Psnum='$bn_4Psnum', bn_lname='$bn_lname', bn_fname='$bn_fname', bn_mname='$bn_mname', bn_nameext='$bn_nameext', bn_contact_num='$bn_contact_num', bn_bday='$bn_bday', bn_age='$bn_age', bn_cstatus='$bn_cstatus', bn_sex='$bn_sex', bn_occupation='$bn_occupation', bn_salary='$bn_salary', bn_reltoclient='$bn_reltoclient', bn_category='$bn_category', bn_subcategory='$bn_subcategory', bn_subcategory2='$bn_subcategory2', bn_ipAffiliation='$bn_ipAffiliation' WHERE cl_qn='".$_SESSION['qn']."' ";
