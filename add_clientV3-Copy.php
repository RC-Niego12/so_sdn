    ...
    <section class="content">
        <?php
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                //cl_category checkbox
                $cl_category = $_POST['cl_category'];
                foreach ($cl_category as $chk1_cl_category) {
                    $chk_cl_category .= $chk1_cl_category.',';
              	} $_SESSION['cl_category'] = $chk_cl_category;
                //cl_subcategory checkbox
                $cl_subcategory = $_POST['cl_subcategory'];
                foreach ($cl_subcategory as $chk1_cl_subcategory) {
                    $chk_cl_subcategory .= $chk1_cl_subcategory.',';
              	} $_SESSION['cl_subcategory'] = $chk_cl_subcategory;
				//cl_subcategory_others
                ...
                $_SESSION['cl_4Psnum'] = mysqli_real_escape_string($conn, test_input($_POST['cl_4Psnum']));
                 ...
                 if (isset($_POST['add_client'])) {
                    ...
                    if ($cl_reltobene == "Self") {
                        header("location: insert_clientBene-Copy.php");
                    } else {
                                                    ...
                                                    <div class="panel panel-primary-dswd">
                                                        ...
                                                        <div class="panel-body">
			                                                ...
			                                                <div class="row clearfix">
                                                                <div style="width: 93%; display: inline-block;">
			                                                        <div class="form-group form-float" style="text-align: left;">
			                                                            <label>Client Category (You can select more than 1 option): <span style="color: red; font-size: 1.5em;">*</span></label>
			                                                            <div class="row cl_category">
		                                                                    <label class="checkbox fhona">
		                                                                      <input type="checkbox" id='fhona' name="cl_category[]" value='FHONA'> (FHONA) Family Head & Other Needy Adult (18-59 y/o)
		                                                                    </label>
		                                                                    <label class="checkbox sc">
		                                                                      <input type="checkbox" id='sc' name="cl_category[]" value='SC'> (SC) Senior Citizen (60 y/o & above)
		                                                                    </label>
		                                                                    <label class="checkbox pwd">
		                                                                      <input type="checkbox" id='pwd' name="cl_category[]" value='PWD'> (PWD) Person With Disability
		                                                                    </label>
		                                                                    <label class="checkbox plhiv">
		                                                                      <input type="checkbox" id='plhiv' name="cl_category[]" value='PLHIV'> (PLHIV) Persons Living w/ HIV-AIDS
		                                                                    </label>
		                                                                    <label class="checkbox wedc">
		                                                                      <input type="checkbox" id='wedc' name="cl_category[]" value='WEDC'> (WEDC) Women/Men in Especially Difficult Circumstances
		                                                                    </label>
		                                                                    <label class="checkbox cnsp">
		                                                                      <input type="checkbox" id='cnsp' name="cl_category[]" value='CNSP'> (CNSP) Child in Need of Special Protection (0-17 y/o)
		                                                                    </label>
		                                                                    <label class="checkbox ynsp">
		                                                                      <input type="checkbox" id='ynsp' name="cl_category[]" value='YNSP'> (YNSP) Youth in Need of Special Protection (18-30 y/o)
		                                                                    </label>
			                                                            </div>
			                                                        </div>
			                                                    </div>
			                                                ...
			                                                <div class="row clearfix">
                                                                <div style="width: 93%; display: inline-block;">
			                                                        <div class="form-group form-float" style="text-align: left;">
			                                                            <label>Client Sub-Category (You can select more than 1 option): <span style="color: red; font-size: 1.5em;">*</span></label>
			                                                            <div class="row cl_subcategory">
		                                                                    <label class="checkbox">
		                                                                      <input type="checkbox" id='sp' name="cl_subcategory[]" value="Solo Parents"> Solo Parents
		                                                                    </label>
		                                                                    <label class="checkbox">
		                                                                      <input type="checkbox" id='ip' name="cl_subcategory[]" value="Indigenous People"> Indigenous People
		                                                                    </label>
		                                                                    <label class="checkbox">
		                                                                      <input type="checkbox" id='rpwud' name="cl_subcategory[]" value="Recovering Person who used drugs
		                                                                     </label>"> Recovering Person who used drugs
		                                                                     </label>
		                                                                    <label class="checkbox">
		                                                                      <input type="checkbox" id='4ps' name="cl_subcategory[]" value="4Ps DSWD Beneficiary"> 4Ps DSWD Beneficiary
		                                                                    </label>
		                                                                    <label class="checkbox">
		                                                                      <input type="checkbox" id='sd' name="cl_subcategory[]" value="Street Dwellers"> Street Dwellers
		                                                                    </label>
		                                                                    <label class="checkbox">
		                                                                      <input type="checkbox" id='pmld' name="cl_subcategory[]" value="Psychosocial/Mental/Learning Disability"> Psychosocial/Mental/Learning Disability
		                                                                    </label>
		                                                                    <label class="checkbox">
		                                                                      <input type="checkbox" id='spasr' name="cl_subcategory[]" value="Stateless Person/Asylum Seekers/Refugees"> Stateless Person/Asylum Seekers/Refugees
		                                                                    </label>
			                                                            </div>
			                                                        </div>
			                                                    </div>
                                                            ...
                                                            <div class="row clearfix" id="div_cl_subcategory_others">
                                                                ...
                                                                <div style="width: 86%; display: inline-block;">
                                                                    <div class="form-group form-float">
			                                                            <label>Other Client Sub-Category (if necessary): <span style="color: red; font-size: 1.5em;">*</span></label>
                                                                        <div class="form-line">
                                                                            <input class="form-control" name="cl_subcategory_others" id="cl_subcategory_others" type="text" placeholder="Please Specify Other Sub-Category Here...">
        ...
        $(document).ready(function() {
            ...
            $("#cl_age").click(function() {
                ...
                if (age >= 60) {
                    ...
                    $( ".plhiv" ).show();
                    $( ".wedc" ).show();
                    $( "#fhona" ).prop( "checked", false );
                    $( "#cnsp" ).prop( "checked", false );
                    $( "#ynsp" ).prop( "checked", false );
