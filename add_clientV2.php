...
<body class="theme-darkblue">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a href="#" class="bars"></a>
                <a class="navbar-brand" href="#" title="Add Client 1.2) Brgy. Address" style="color: white;"><?php echo $sysname.' ('.$sys_acronym.')'; ?>: Verifier Level</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="add_clientV2.php">
                            <span class="glyphicon glyphicon-plus"></span>
                            <span>Add Client 1.2</span>
                        </a>
                    </li>
                    <li>
    ...
    <section class="content">
        <?php
            //client session
            $_SESSION['cl_brgy_name'] = $_SESSION['cl_brgy_code'] = "";
            ...
            if (isset($_POST['btn_submit_loc'])) {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    header("location: add_clientV3.php");
                }
            }
                                    ...
                                    <div class="tab-content" style="margin-top: 10px; overflow-y: auto; margin: -1px;">
                                        ...
                                        <div class="container-fluid" style="opacity: 0.9;">
                                            ...
                                            <div class="row">
                                                ...
                                                <h5 style="margin: -15px 0px 0px 15px; padding: 10px 0; color: darkblue; text-align: left;">1.2) Brgy. Address</h5>
                                                            ...
                                                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable text-left" style="overflow-x: scroll;">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                        ...
                                                                        $loc_sql = mysqli_query($conn, "SELECT * FROM tbl_ph_brgy WHERE mun_city_code='".$_SESSION['cl_mc_code']."' ");
                                                        ...
                                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                                                            ...
                                                            <div class="row clearfix">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_brgy_name" name="cl_brgy_name" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row clearfix">
                                                                <div class="form-group form-float">
                                                                    ...
                                                                    <div class="form-line">
                                                                        <input type="text" class="form-control" id="cl_brgy_code" name="cl_brgy_code" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
