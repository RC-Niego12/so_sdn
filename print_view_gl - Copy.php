    ...
    <body class="theme-darkblue">
        <div class="">
            <page size="A4flex" layout="orientation" class="page2">
                ...
                <br><br>
                <p style="font-size: 15px; text-align: left; margin: 0px;">Date: <?php echo date_format(new DateTime('2023-11-30 17:42:12'), "M. d, Y");?></p>
                <br>
                ...
                <?php
                    ...
                    $issued = date_create('2023-11-30 17:42:12');
                    date_add($issued, date_interval_create_from_date_string("3 days"));
                ...
                ?>
                <p style="font-size: 14px;"><b>Valid Until:</b> <?php echo date_format($issued, "M. d, Y"); ?></p>
