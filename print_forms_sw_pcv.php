<?php
    // Start the session
    session_start();
     $_SESSION['cl_qn2']; $_SESSION['date_added']; $_SESSION['staffid']; $_SESSION['uname']; $_SESSION['pword'];
    include 'config.php';
...
<body class="theme-darkblue">
                ...
                <ul class="list">
                    <li>
                        <a href="home_sw.php">
                            ...
                            <span>Go Back to Home (after printing)</span>
                        </a>
                    </li>
                    <li class="active">
                        <a href="print_forms_sw_pcv.php">
                            <span class="fa fa-print"></span>
                            <span>Print Forms (PCV)</span>
                        </a>
                    </li>
                    <li>
                </ul>
    ...
    <script>   
        function print_filecopy_gis() {
          window.open("print_filecopy_gis2.php");
        }
        function print_filecopy_pcv() {
          window.open("print_filecopy_pcv2.php");
        }
        function print_filecopy_coe_pcv() {
          window.open("print_filecopy_coe_pcv2.php");
        }
